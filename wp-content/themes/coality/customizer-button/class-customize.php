 ...
 * @access public
 */
final class coality_button_customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'coality_customize_section_pro' );

		// Register sections.
		$manager->add_section(
			new coality_customize_section_pro(
				$manager,
				'button',
				array(
					'title'    => esc_html__( 'Need Help?', 'coality' ),
					'pro_text' => esc_html__( 'View Documentation', 'coality' ),
					'pro_url'  => 'https://www.webhuntinfotech.com/coality-wordpress-theme-documentation/',
					'priority'=>0
				)
			)
		);
...
coality_button_customize::get_instance();

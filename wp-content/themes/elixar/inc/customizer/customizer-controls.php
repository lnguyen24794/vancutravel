...
/**
 * Class Elixar_Fontawesome_Icon_Chooser
 * @since 0.1
 */
class Elixar_Fontawesome_Icon_Chooser extends WP_Customize_Control{
	public $type = 'icon';
	public function render_content(){
		?>
            <label>
	            ...
	            <?php } ?>
                <div class="elixar-selected-icon">
                	<i class="fa <?php echo esc_attr($this->value()); ?>"></i>
                	<span><i class="fas fa-angle-down"></i></span>
                </div>
                <ul class="elixar-icon-list clearfix">
                	<?php
                	$elixar_font_awesome_icon_array = elixar_font_awesome_icon_array();
                	foreach ($elixar_font_awesome_icon_array as $elixar_font_awesome_icon) {
							$icon_class = $this->value() == $elixar_font_awesome_icon ? 'icon-active' : '';
							echo '<li class='.$icon_class.'><i class="'.$elixar_font_awesome_icon.'"></i></li>';
						}
                	?>
                </ul>
                <input type="hidden" value="<?php esc_attr( $this->value() ); ?>" <?php esc_url( $this->link() ); ?> />
            </label>
		<?php
	}
}
	...
	public function render_content(){
		...
		?>
            <label>
				...
				<?php }
				?>
                <select data-placeholder="<?php echo esc_attr( $this->placeholder ); ?>" multiple="multiple" class="wh-chosen-select" <?php esc_url( $this->link() ); ?>>
                    <?php
...
function elixar_customizer_control_scripts(){
    ...
    wp_enqueue_script( 'elixar-customizer', get_template_directory_uri() . '/js/customizer_js/js/elixar-customizer.js', array( 'customize-controls', 'wp-color-picker' ) );
    wp_enqueue_style( 'elixar-customizer-css',  get_template_directory_uri() . '/css/customizer_css/css/elixar-customizer'.$min.'.css' );
	wp_enqueue_script( 'elixar-customizer-chosen-script', get_template_directory_uri() .'/js/customizer_js/js/chosen.jquery'.$min.'.js', array("jquery") );	
	wp_enqueue_style( 'elixar-customizer-chosen-style', get_template_directory_uri() .'/css/customizer_css/css/chosen'.$min.'.css');
}

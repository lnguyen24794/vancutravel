 ...
 */
class Elixar_Custom_Radio_Image_Control extends WP_Customize_Control
{
    /**
...
class Elixar_Custom_sortable_Control extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        wp_enqueue_style('elixar-customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/css/customizer_css/css/elixar-admin-style.css', time());
        wp_enqueue_script('elixar-customizer-repeater-script', get_template_directory_uri() . '/js/customizer_js/js/elixar-customizer_repeater.js', array('jquery', 'jquery-ui-draggable'), time(), true);
    }
    /**
     * Render the control to be displayed in the Customizer.
     */
    public function render_content()
    {
		...
		<?php if (!empty($this->description)): ?>
			<span class="description customize-control-description"><?php echo esc_html($this->description); ?></span>
		<?php endif;?>
		<div class="elixar-customizer-repeater-general-control-repeater customizer-repeater-general-control-droppable">
			<?php 
			if(!empty($values)){ 
				foreach ($values as $value) {?>
					<div class="elixar-customizer-repeater-general-control-repeater-container customizer-repeater-draggable ui-sortable-handle">
					<div class="customizer-repeater-customize-control-title">
						<?php echo esc_html( $this->choices[$value] ); ?>
					</div>
					<input type="hidden" class="elixar-section-id" value="<?php echo esc_attr( $value ); ?>">
					</div>	
				<?php }?>
			<?php }else{
			foreach ($this->choices as $value => $label): ?>
        		...
        		if (!empty($value)) { ?>
					<input type="hidden"
					       ...
					       class="elixar-customizer-repeater-colector"
